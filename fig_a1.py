...
class Parameters:
    # Trial Setup
    trial_name = 'fig_a1'  # should match file name
    # starting values of x and t
    x = np.array([5, 0])  # 2-vector
    t = 0
    t_span = 5 #200
    ...
    # Long Term Memory
    alpha = 1  # scalar or none. Positive in our work for attractive long-term memory
    ...
    # Short Term Memory
    beta = -40  # scalar or none. Negative in our work for repulsive short-term memory
    ...
    drift_params = (10, np.zeros(2))  # parameters for the function above
    ...
    def arrive_destination(self):
        ...
        # moves x to "drop site" x_0, resets short-term memory
